...
conclusion <- tabPanel(
  ...
  h3("Takeaway 2"),
  p("Additionally, our observations show that the relationship between new deaths 
     and vaccines is highly correlated."),
  p("As more vaccines continue to be administered, the rate of new deaths due to 
    COVID-19 decreases. "),
