...
covid_dataset <- covid_data[c("date", "total_cases", "new_cases", "total_deaths", "new_deaths", "total_vaccinations")]

#new dataset for the vaccination data that includes only needed columns
vaccination_dataset <- covid_vaccination[c("date", "total_vaccinations", "people_vaccinated", "people_fully_vaccinated", "total_boosters")]
